...
const Home = () => {
  ...
  return <MobileLayout>
      {/* Profile header */}
      <div className="bg-primary px-5 pt-12 rounded-b-3xl py-[42px] my-0 pb-[30px]">
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-3 md:gap-4">
          ...
          value: '1',
          icon: AlertTriangle
        }].map(stat => <div key={stat.label} className="bg-primary-foreground/10 rounded-xl p-3 text-center">
